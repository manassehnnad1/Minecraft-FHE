...
export type { AgeVerifier } from "./contracts/FHEageverifier.sol/AgeVerifier";
export { AgeVerifier__factory } from "./factories/contracts/FHEageverifier.sol/AgeVerifier__factory";
